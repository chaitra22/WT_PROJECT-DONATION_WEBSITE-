			...
			<div class="row section-content">
				<div class="contact-us-section-content">
							...
							<div class="col-md-3 col-sm-6">
								<div class="way-help-pic-text text-center colmd3">
									...
									<div class="way-help-text">
										...
										<div class="way-help-text-content">
											<p>800 723 1646<br>697 670 0000</p>
										</div>
									</div>
									<!-- /text -->
								</div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="way-help-pic-text text-center colmd3">
									...
									<div class="way-help-text">
										...
										<div class="way-help-text-content">
											<p>tejasksagar@gmail.com <br>tpkshirsagar@mitaoe.ac.in</p>
										</div>
									</div>
									<!-- /text -->
								</div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="way-help-pic-text text-center colmd3">
									...
									<div class="way-help-text">
										...
										<div class="way-help-text-content">
											<p>NOthing for now <br>nothing for now</p>
										</div>
									</div>
									<!-- /text -->
								</div>
					...
					<div class="contact-form">
						...
						<div class="contact-comment-form pb50 clearfix">
							<div class="comment-form">
								<form id="contact_form" action="contact.php" method="POST" enctype="multipart/form-data">
									...
									<div class="contact-comment-info">
										<div class="contact-comment-info">
											<input class="email" name="mobile" type="text" placeholder="Phone Number...">
										</div>
									</div>
									<div class="contact-comment-info">
										<input class="email" name="cause" type="text" placeholder="You want to raise funds for...">
									</div>
									<div class="contact-comment-info">
										<input class="name" name="amount" type="text" placeholder="What is your goal...">
									</div>
									
									<div class="contact-comment-info mt25">
										<textarea id="message" name="discription" placeholder="Give a short description... " rows="7" cols="30"></textarea>
									</div>
									<div class="send-button text-uppercase text-center">
										<button type="submit" name="contact"value="Submit">SEND REQUEST</button> 
									</div>
								</form>
							</div>
						</div>
						...
						$q="INSERT INTO `admin_request`( `name`, `email`, `mobile`, `cause`, `amount`, `description`) VALUES ('$name','$email','$mobile','$cause','$goal_amount','$discription')";
